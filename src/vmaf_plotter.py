...
def parse_arguments():
    ...
    main_parser = subparsers.add_parser("Main", help="Main arguments")
    config_args = main_parser.add_argument_group("Configuration arguments")
    main_args = main_parser.add_argument_group("Input & output file arguments")
    types_args = main_parser.add_argument_group("Output media & data arguments")
    data_args = main_parser.add_argument_group("Output data arguments")

    optional_parser = subparsers.add_parser("Optional", help="Optional arguments")
    threading_args = optional_parser.add_argument_group("Multithreading arguments")
    ...
    config_help = "TOML Configuration file.\n"
    config_args.add_argument(
        "-c", "--config", dest="config", default="pyproject.toml", help=config_help, widget="FileChooser"
    )

    vmaf_help = "VMAF report directory.\n"
    vmaf_help += "This should be the directory that was generated by the VMAF Calculator.\n"
    main_args.add_argument("VMAF", type=str, help=vmaf_help, widget="DirChooser")

    output_help = "Output files location.\n"
    ...
    main_args.add_argument("-o", "--output", dest="output", type=str, help=output_help, widget="DirChooser")
    ...
    data_args.add_argument("-f", "--fps", dest="fps", default=60.0, type=float, help=fps_help)

    threads_help = "Specify number of CPU threads to use for calculating the different VMAF statistics.\n"
    threads_help += ""
    threading_args.add_argument(
        ...
        help=threads_help,
        widget="Slider",
        gooey_options={"min": 1, "max": mp.cpu_count()},
    )
